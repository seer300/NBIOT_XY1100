...
# directory
####################################################################################################
FLASH_SRC_DIR := $(SYSAPP_SRC_DIR)/flash
...
# add to sysapp.mk
####################################################################################################
SRCS_SYSAPP_RAM   += $(SRCS_FLASH_RAM)
SRCS_SYSAPP_FLASH += $(SRCS_FLASH_FLASH)

SYSAPP_EXCLUDE_LIB_RAM   += $(FLASH_EXCLUDE_LIB_RAM)
SYSAPP_EXCLUDE_LIB_FLASH += $(FLASH_EXCLUDE_LIB_FLASH)

DEPS_PATH_SYSAPP += $(DEPS_PATH_FLASH)