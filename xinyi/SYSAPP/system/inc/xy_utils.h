...
typedef enum
{
  ...
  XY_OS_PRIO_LOW1,
  XY_OS_PRIO_LOW2 ,
  XY_OS_PRIO_NORMAL = osPriorityNormal,   //user_psnetif_process+passthrough_process+socket_demo_recv_func
  XY_OS_PRIO_NORMAL1,             //cloud task
  XY_OS_PRIO_NORMAL2,             //tcpip_thread+at_sock_recv_thread+AtcAp_TaskEntry
