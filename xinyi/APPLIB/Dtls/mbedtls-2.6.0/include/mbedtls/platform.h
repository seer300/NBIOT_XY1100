...
#define MBEDTLS_PLATFORM_STD_PRINTF   xy_printf /**< Default xy_printf to use  */
#endif
...
/*
 * The function pointers for xy_printf
 */
#if defined(MBEDTLS_PLATFORM_PRINTF_ALT)
extern int (*mbedtls_printf)( const char *format, ... );

/**
 * \brief   Set your own xy_printf function pointer
 *
 * \param printf_func   the xy_printf function implementation
 *
 * \return              0
 */
