...
#if VER_QUCTL260
    { D_ATC_EVENT_QPLMNS_T,                     AtcAp_QPLMNS_T_LNB_Process      },
#endif
    { D_ATC_EVENT_QLOCKF_T,                     AtcAp_QLOCKF_T_LNB_Process      },
    { D_ATC_EVENT_ECURC_T,                      AtcAp_ECURC_T_LNB_Process       },
    { D_ATC_EVENT_QENG_T,                       AtcAp_QENG_T_LNB_Process        },
    { D_ATC_EVENT_QEDRXCFG_T,                   AtcAp_QEDRXCFG_T_LNB_Process    },
};

const ST_ATC_AP_CMD_PROC_TABLE AtcAp_DataIndProcTable[D_ATC_DATAIND_PROC_TBL_SIZE] = 
{
    //OK/Err
...
#if VER_QUCTL260
    { D_ATC_EVENT_QPLMNS_R,                     AtcAp_MsgProc_QPLMNS_R_Cnf      },
#endif
...
#if VER_QUCTL260
    { {(unsigned char *)"+QPLMNS" },         ATC_QPLMNS_LNB_Command         },
#endif
    { {(unsigned char *)"+QLOCKF"     },     ATC_QLOCKF_LNB_Command         },
    { {(unsigned char *)"+ECURC"      },      ATC_ECURC_LNB_Command         },
    { {(unsigned char *)"+QENG"       },     ATC_QENG_LNB_Command           },
    { {(unsigned char *)"+QNBIOTEVENT"},     ATC_QNBIOTEVENT_LNB_Command    },
...
#if VER_QUCTL260
    {   0xFF,                       D_ATC_EVENT_QPLMNS_R,       D_ATC_EVENT_QPLMNS_T,     D_ATC_EVENT_QPLMNS},   /* EVENT_QPLMNS */
#endif
...
const ST_ATC_STR_TABLE ATC_PdpType_Table[D_ATC_PDPTYPE_LIST_NUM] = 
{
    {   D_PDP_TYPE_IPV4,          "IP"             },
    {   D_PDP_TYPE_IPV4,          "ip"             },
