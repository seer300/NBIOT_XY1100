                                             ...
                                             unsigned char *pTblPosition)
{
    ...
    *pTblPosition = ATC_NG;
    ...
    for(;;)
    {
        if(pCommandBuffer[ucAtHeadLen] == '?' || pCommandBuffer[ucAtHeadLen] == '=' || pCommandBuffer[ucAtHeadLen] == '\r')
        {
            break;
        }
        ucAtHeadLen++;
    ...
    for (; ;)
    {
        ...
        if(strlen((char*)pTblPtr[ucCtr].LetterData.CommandLetter) != ucAtHeadLen)
        {
            ucCtr++;
            continue;
        }
...
//    case D_ATC_EVENT_CNMA:
    ...
    case D_ATC_EVENT_QEDRXCFG_R:
    case D_ATC_EVENT_QEDRXCFG_T:
