...
extern const ST_ATC_AP_STR_TABLE              ATC_ECURC_Table[D_ATC_ECURC_MAX];
...
extern const ST_ATC_STR_TABLE                 ATC_PdpType_Table[D_ATC_PDPTYPE_LIST_NUM];
...
extern const ST_ATC_AP_CMD_PROC_TABLE         AtcAp_DataIndProcTable[D_ATC_DATAIND_PROC_TBL_SIZE];
...
#if ATC_DSP
#define  AtcAp_Malloc(ulSize)                                  PsMalloc(ulSize, 0) 
...
#else
#define  AtcAp_Malloc(ulSize)                                  xy_zalloc(ulSize)
...
#else
#define AtcAp_PrintLog(dyn_id, src_id, lev, fmt, ...)          softap_printf(ATC_AP,lev,fmt, ##__VA_ARGS__)
#endif
#define PS_TRACE 
...
#if VER_QUCTL260
extern unsigned char AtcAp_QPLMNS_T_LNB_Process(unsigned char *pEventBuffer);
#endif
extern unsigned char AtcAp_QLOCKF_T_LNB_Process(unsigned char *pEventBuffer);
extern unsigned char AtcAp_ECURC_T_LNB_Process(unsigned char *pEventBuffer);
extern unsigned char AtcAp_QENG_T_LNB_Process(unsigned char *pEventBuffer);
extern unsigned char AtcAp_QEDRXCFG_T_LNB_Process(unsigned char *pEventBuffer);
...
extern void AtcAp_MsgProc_QEDRXCFG_R_Cnf(unsigned char* pRecvMsg);
...
#if VER_QUCTL260
extern void AtcAp_MsgProc_QPLMNS_R_Cnf(unsigned char* pRecvMsg);
#endif
...
#if VER_QUCTL260
extern unsigned char ATC_QPLMNS_LNB_Command(unsigned char *pCommandBuffer, unsigned char *pEventBuffer);
#endif
extern unsigned char ATC_QLOCKF_LNB_Command(unsigned char *pCommandBuffer, unsigned char *pEventBuffer);
extern unsigned char ATC_ECURC_LNB_Command(unsigned char *pCommandBuffer, unsigned char *pEventBuffer);
