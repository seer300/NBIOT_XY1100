...
typedef struct coap_context_t {
  ...
  int (*network_send)(coap_socket_t *sock, const coap_session_t *session, const uint8_t *data, size_t datalen);

  int (*network_read)(coap_socket_t *sock, struct libcoap_coap_packet_t *packet);
