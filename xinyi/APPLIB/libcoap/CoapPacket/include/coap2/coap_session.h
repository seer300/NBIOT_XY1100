...
*/
int coap_session_send(coap_session_t *session,
...
*                         less than zero on error.
*/
int coap_session_write(coap_session_t *session,
  const uint8_t *data, size_t datalen);
...
*                         less than zero on error.
*/
int coap_session_send_pdu(coap_session_t *session, coap_pdu_t *pdu);
...
coap_session_t *coap_endpoint_get_session(coap_endpoint_t *endpoint,
  const struct libcoap_coap_packet_t *packet, coap_tick_t now);
