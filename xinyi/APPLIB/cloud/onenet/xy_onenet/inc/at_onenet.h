...
#if VER_QUCTL260
#define CIS_PARAM_ERROR       652
#define CIS_STATUS_ERROR      653
#define CIS_SDK_ERROR		  654
#define CIS_UNKNOWN_ERROR     655
#else
...
typedef struct onenet_user_config_s {
...
typedef struct onenet_context_reference_s {
    ...
    onenet_user_config_t onenet_user_config;
