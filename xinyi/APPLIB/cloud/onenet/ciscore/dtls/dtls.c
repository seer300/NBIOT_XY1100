                                         ...
                                         int              add_hash )
{
    ...
    return dtls_send_multi( ctx, peer, security, session, DTLS_CT_HANDSHAKE,
                            data_array, data_len_array, i, PS_SOCK_RAI_NO_INFO );
}
                                   ...
                                   dtls_alert_t       description )
{
    ...
    dtls_send( ctx, peer, DTLS_CT_ALERT, msg, sizeof(msg) , PS_SOCK_RAI_NO_INFO);
    return 0;
}
                                 ...
                                 dtls_peer_t    *peer )
{
    ...
    return dtls_send( ctx, peer, DTLS_CT_CHANGE_CIPHER_SPEC, buf, 1 , PS_SOCK_RAI_NO_INFO);
}
...
void dtls_check_retransmit( dtls_context_t *context)
{
    ...
    while ( node && node->t <= now )
    {
        ...
        dtls_retransmit( context, node , PS_SOCK_RAI_NO_INFO);
