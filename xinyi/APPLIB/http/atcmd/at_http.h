...
extern int at_http_create(char *at_buf, char **rsp_cmd);
extern int at_http_cfg(char *at_buf, char **rsp_cmd);
extern int at_http_header(char *at_buf, char **rsp_cmd);
extern int at_http_content(char *at_buf, char **rsp_cmd);
extern int at_http_send(char *at_buf, char **rsp_cmd);
extern int at_http_close(char *at_buf, char **rsp_cmd);
