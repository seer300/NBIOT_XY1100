...
void connection_task(void *args)
{
	...
	g_user_dog_timer = osTimerNew((osTimerFunc_t)(dog_timeout), osTimerOnce, NULL, &timer_attr);
...
void  connection_demo_init()
{
	...
	thread_attr.name	   = "connection_demo";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = 0x800;
	g_connection_TskHandle = osThreadNew ((osThreadFunc_t)(connection_task),NULL,&thread_attr);
