...
void coap_downlink_messgae_process_thread_create()
{
	...
	thread_attr.name       = "coap_downlink_messgae_process";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = 0x1000;
	g_coapdownlink_handle = osThreadNew ((osThreadFunc_t)(coap_downlink_messgae_rev),NULL,&thread_attr);
}
...
void coap_opencpu_demo_init()
{
	...
	thread_attr.name	   = "coap_test_demo";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = 0x1000;
	g_coaptest_handle = osThreadNew ((osThreadFunc_t)(coap_test_demo),NULL, &thread_attr);
}
