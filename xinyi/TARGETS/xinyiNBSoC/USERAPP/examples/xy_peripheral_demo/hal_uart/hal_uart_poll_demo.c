...
void hal_uart_poll_demo_task_init(void)
{
	...
	thread_attr.name	   = "hal_uart_poll_demo_task";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = 512;
	hal_uart_poll_demo_TskHandle = osThreadNew((osThreadFunc_t)hal_uart_poll_demo_task, NULL, &thread_attr);
}
