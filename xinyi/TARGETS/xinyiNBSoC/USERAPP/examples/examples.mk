...
SRCS_EXAMPLES_C_FLASH = \
	...
	$(wildcard $(EXAMPLES_SRC_DIR)/xy_fota_demo/by_http/*.c) \
	...
	$(wildcard $(EXAMPLES_SRC_DIR)/xy_peripheral_demo/hal_gpi/*.c) \
...
DEPS_PATH_EXAMPLES += $(EXAMPLES_SRC_DIR)/xy_fota_demo/by_http
