...
void lcd_spi_master_work_task_init(void)
{
	...
	thread_attr.name	   = "lcd_spi_master_work_task";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = SPI_MASTER_STACK_SIZE;
	g_lcd_spi_master_TskHandle = osThreadNew ((osThreadFunc_t)(lcd_spi_master_work_task),NULL,&thread_attr);
