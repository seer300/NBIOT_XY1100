...
void spi_flash_work_task_init(void)
{
	...
	thread_attr.name	   = "spi_flash_work_task";
	thread_attr.priority   = osPriorityNormal;
	thread_attr.stack_size = SPI_FLASH_STACK_SIZE;
	g_spi_flash_TskHandle = osThreadNew ((osThreadFunc_t)(spi_flash_work_task),NULL,&thread_attr);
}
#endif
