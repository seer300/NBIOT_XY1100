...
typedef enum {
  ...
  osPriorityLow           = 4,          ///< Priority: low                 wdt_task
  osPriorityLow1          = 4+1,        ///< Priority: low + 1             xy_diag_read
  osPriorityLow2          = 4+2,        ///< Priority: low + 2
  osPriorityLow3          = 4+3,        ///< Priority: low + 3
  osPriorityBelowNormal   = 8,          ///< Priority: below normal        xy_log_entry
  ...
  osPriorityNormal        = 12,         ///< Priority: normal           demo_task+user_psnetif_process+passthrough_process+socket_demo_recv_func
  osPriorityNormal1       = 12+1,       ///< Priority: normal + 1      query_ntp_task+proxy_smartcard_task+cloud task...
  osPriorityNormal2       = 12+2,       ///< Priority: normal + 2       at_ctl+tcpip_thread+at_sock_recv_thread+AtcAp_TaskEntry
  osPriorityNormal3       = 12+3,       ///< Priority: normal + 3       AT_uart_rx_task+inter_core_msg_entry+rtc_tmr_entry
