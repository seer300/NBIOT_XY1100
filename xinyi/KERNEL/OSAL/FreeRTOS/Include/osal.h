 ...
 * @param attr      [IN] 线程属性，设置线程名称、栈大小、优先级等，详见osThreadAttr_t
 ...
 * @param attr     	[IN] 软件定时器的属性，设置定时器的名称等，详见osTimerAttr_t
 ...
 * @param	 attr       [IN]  消息队列属性，通常设为NNULL
 * @code
    void  init_user_task()
    {
	    ............
