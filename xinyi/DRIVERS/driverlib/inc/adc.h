...
#define WAIT_DSP_ADC_IDLE()		while(HWREG(CP_ADC_FLAG))
#define SET_ARM_ADC_BUSY()		do{(HWREG(AP_ADC_FLAG)=1);}while(0)
#define SET_ARM_ADC_IDLE()		do{(HWREG(AP_ADC_FLAG)=0);}while(0)
